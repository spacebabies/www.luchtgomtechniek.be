...
{{< grids/gallery id="gallery-kabien" >}}
  ![surfaces avec finition en poudre enduite de vernis, une préparation propre est un must absolu]({{ .Resources.GetMatch "kabien1.jpg" }} "Ook al een leuke titel")
{{ /grids/gallery >}}
